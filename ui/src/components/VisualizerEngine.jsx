...
const VisualizerEngine = ({ steps }) => {
  ...
  if (!steps || steps.length === 0) {
    return (
      <div className="visualizer-container">
        <div className="visualizer-canvas visualizer-canvas-empty">
          <span className="text-secondary empty-state-text">Select a problem to visualize.</span>
        </div>
      </div>
    );
  }
  ...
  const variables = Object.entries(structures).filter(([, data]) => data.type === 'variable');
  const otherStructures = Object.entries(structures).filter(([, data]) => data.type !== 'variable');
    ...
    <div className="visualizer-container">
      <div className="controls-bar">
        ...
        <div className="progress-container">
          ...
          <span className="text-secondary progress-text">
